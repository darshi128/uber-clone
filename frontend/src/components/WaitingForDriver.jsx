...
const WaitingForDriver = (props) => {
  return (
     <div>
        <h5 onClick={()=>{props.setWaitngForDriver(false)}} className='p-1 w-[93%] text-center absolute top-0 '><i className="text-3xl text-gray-200 ri-arrow-down-wide-fill"></i></h5> 
